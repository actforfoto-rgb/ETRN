...
public class EpguV114ResponseContractTest {
    @Test public void pushOrderIdAcceptsIntegerAndDigitString(){
    ...
    @Test public void pushOrderIdRejectsMissingFractionalAndZero(){
    ...
    @Test public void parsesStringifiedOrderAndResponseFiles(){
    ...
    @Test public void parsesObjectAndLegacyDirectShapes(){
    ...
    @Test public void rejectsWrongServiceAndDuplicateResultNames(){
    ...
    @Test public void objectTypeSupportsTerrabyteAndOrdinaryLinks(){
